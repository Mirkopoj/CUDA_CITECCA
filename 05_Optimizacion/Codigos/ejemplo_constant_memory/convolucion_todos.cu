...
int main(int argc, char *argv[]) 
{
	...
	gpu_timer crono;
			...
			crono.tac();
			printf("filtro e input en memoria global: %lf \n", crono.ms_elapsed);
	...
	cudaMemset(d_output,0,N * sizeof(FLOAT));
	        ...
	        cudaDeviceSynchronize();
			crono.tac();
			printf("filtro en memoria constante, input en memoria global: %lf \n", crono.ms_elapsed);
	...
	cudaMemset(d_output,0,N * sizeof(FLOAT));
	        ...
	        cudaDeviceSynchronize();
			crono.tac();
			printf("filtro en memoria shared, input en memoria global: %lf \n", crono.ms_elapsed);
	...
	cudaMemset(d_output,0,N * sizeof(FLOAT));
			...
			cudaDeviceSynchronize();
			crono.tac();
			printf("filtro en memoria shared, input en memoria shared: %lf \n", crono.ms_elapsed);
	...
	cudaMemset(d_output,0,N * sizeof(FLOAT));
			...
			cudaDeviceSynchronize();
			crono.tac();
			printf("filtro en memoria constante, input en memoria shared: %lf \n", crono.ms_elapsed);
	...
	cudaMemset(d_output,0,N * sizeof(FLOAT));
			...
			cudaDeviceSynchronize();
			crono.tac();
			printf("filtro en registro, input en memoria global: %lf \n", crono.ms_elapsed);
